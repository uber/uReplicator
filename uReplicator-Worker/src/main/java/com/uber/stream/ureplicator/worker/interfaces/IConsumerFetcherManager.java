...
import com.uber.stream.ureplicator.worker.PartitionOffsetInfo;
import java.util.Set;
import org.apache.kafka.common.TopicPartition;

public interface IConsumerFetcherManager {

  void start();

  void addTopicPartition(TopicPartition topicPartition, PartitionOffsetInfo partitionInfo);
