...
public class HelixMirrorMakerManagerCustomFullTest {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(HelixMirrorMakerManagerCustomFullTest.class);
  ...
  public void testControllerStarter() throws Exception {
    ...
    for (int i = 0; i < numTotalTopics; ++i) {
      ...
      Thread.sleep(5000);
      assertInstanceOwnedTopicPartitionsBalanced(helixMirrorMakerManager, 10, 8 * (i + 1));
    }
    ...
    Thread.sleep(5000);
    assertInstanceOwnedTopicPartitionsBalanced(helixMirrorMakerManager, 20, 8 * numTotalTopics);
    ...
    for (int i = 0; i < numTotalTopics; ++i) {
      ...
      Thread.sleep(5000);
      assertInstanceOwnedTopicPartitionsBalanced(helixMirrorMakerManager, 20,
          8 * numTotalTopics + 8 * (i + 1));
    }
